...
CREATE TABLE IF NOT EXISTS fiscal_years (
  ...
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW() NOT NULL,
  CONSTRAINT uq_fiscal_years_tenant_company_id UNIQUE(tenant_id, company_id, id)
);
...
CREATE TABLE IF NOT EXISTS fiscal_periods (
  ...
  tenant_id VARCHAR(255) NOT NULL REFERENCES tenants(id) ON DELETE RESTRICT,
  company_id VARCHAR(255) NOT NULL REFERENCES companies(id) ON DELETE RESTRICT,
  fiscal_year_id VARCHAR(255) REFERENCES fiscal_years(id) ON DELETE RESTRICT,
  name VARCHAR(255) NOT NULL,
  start_date VARCHAR(50) NOT NULL,
  end_date VARCHAR(50) NOT NULL,
  status VARCHAR(50) DEFAULT 'OPEN' NOT NULL,
...
CREATE TABLE IF NOT EXISTS journal_entries (
  ...
  company_id VARCHAR(255) NOT NULL REFERENCES companies(id) ON DELETE RESTRICT,
  branch_id VARCHAR(255) REFERENCES branches(id) ON DELETE RESTRICT,
  fiscal_period_id VARCHAR(255) REFERENCES fiscal_periods(id) ON DELETE RESTRICT,
  date VARCHAR(50) NOT NULL,
  reference VARCHAR(255) NOT NULL,
  notes TEXT,
  posted BOOLEAN DEFAULT false NOT NULL,
  workflow_status VARCHAR(50) DEFAULT 'Draft' NOT NULL,
...
CREATE TABLE IF NOT EXISTS stock_batches (
  ...
  warehouse_id VARCHAR(255) NOT NULL REFERENCES warehouses(id) ON DELETE RESTRICT,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW() NOT NULL
);
...
CREATE TABLE IF NOT EXISTS sales_invoices (
  ...
  type VARCHAR(50) NOT NULL,
  currency VARCHAR(10) DEFAULT 'SAR' NOT NULL,
  exchange_rate NUMERIC(15,4) DEFAULT 1.0000 NOT NULL,
